"""Regression checks for the sonar-gfx-font-scope casebook."""
...
from casebook.harness import assert_expected, sonar_gfx_font_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(sonar_gfx_font_scope_summary(), assert_expected())
