...
`sonar-gfx-font-scope` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for font systems, covering stream reduction, windowed input fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 164. Risk has a penalty of 4, latency has a penalty of 2, and weight contributes a bonus of 5.
